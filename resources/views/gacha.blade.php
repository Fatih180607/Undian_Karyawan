        ...
        let shuffle = setInterval(() => {
            ...
            if (Date.now() - startTime > 5000) {
                ...
                setTimeout(() => {
                    ...
                    // --- LOGIKA BARU ---
                    // 1. Tetap pakai nama hadiah yang diketik user
                    pTitle.innerText = selectedPrizeName || "HADIAH MISTERI";

                    // 2. Cari fotonya di database
                    let pObj = prizes.find(p => p.nama_hadiah === selectedPrizeName);

                    if (pObj && pObj.foto_hadiah) {
                        // Kalau ada hadiahnya & ada fotonya, pakai foto itu
                        pImg.src = "/images/" + pObj.foto_hadiah;
                    } else {
                        // Kalau cuma ketik manual/ga ada foto, pakai mystery_box
                        pImg.src = "/images/mystery_box.jpg";
                    }
                ...
                }, 8000); // Muncul di detik ke-13 total
            }
        }, 80);
    }
</script>
